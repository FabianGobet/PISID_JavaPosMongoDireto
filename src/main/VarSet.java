...
public class VarSet {
    ...
    public synchronized void setVars(ResultSet javaopSet) throws SQLException {
    ...
    public class Vars implements Serializable {
        ...
        public Vars(ResultSet res) throws SQLException {
            ...
            this.periodicidade = calcPeriodicidade(this.tempo_max_periodicidade,this.segundos_abertura_portas_exterior, this.tempo_entre_experiencia,this.fator_periodicidade.longValue());
        }
        private static long calcPeriodicidade(int segMaxPer, int segAbrirPortas, int segMaxTempExp, long factorPer) {
